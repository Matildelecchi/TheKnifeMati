...
public interface DBService extends Remote {
    ...
    ArrayList<Ristorante> getRistoranti() throws RemoteException, SQLException;
    ...
    boolean existRisposta(int id_rec) throws RemoteException, SQLException;
    ...
    boolean existRecensione(int id_rec) throws RemoteException, SQLException;
